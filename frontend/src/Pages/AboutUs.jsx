        ...
        <div className="card mt-5 ps-3">
          <div className="card-body">
              ...
              <p style={{textIndent:'3em'}} className='mt-4'>
                IHAVEFurniture ถูกสร้างขึ้เพื่อนจำลองเว็บไซต์ในรูปแบบของ E-commerce โดยมีเป้าหมายเพื่อสึกษาวิธีการสร้างสรรค์ และวิธีดำเนินงานของการสร้างเว็บไซต์
              ...
              <p>เพื่อเป้าหมายในการศึกษาวิธีการทำงานที่สมาชิกแต่ละคนนั้นสนใจได้อย่างชัดเจน และจะทำการแบ่งปันความรู้ที่ได้แยกกันศึกษาในช่วงท้ายของกรทำโครงการ</p>
          </div>
        </div>
